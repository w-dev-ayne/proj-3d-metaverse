...
public static class Extension
{
	...
	public static void BindEvent(this GameObject go, Action action, String clipName = UIManager.Button_Sound, Define.UIEvent type = Define.UIEvent.Click)
	{
		UI_Base.BindEvent(go, action, clipName, type);
	}
	
	public static void BindEventOnPointerDown(this GameObject go, Action action, String clipName = UIManager.Button_Sound, Define.UIEvent type = Define.UIEvent.PointerDown)
	{
		UI_Base.BindEvent(go, action, clipName, type);
	}
