...
public class SoundManager
{
	...
	public float MasterVolume
	{
		...
		{
			masterVolume = value;
			_audioSources[(int)Define.Sound.Bgm].volume = BgmVolume * masterVolume;
			_audioSources[(int)Define.Sound.Effect].volume = EffectVolume * masterVolume;
		}
	}
	...
	public float BgmVolume
	{
		...
		{
			bgmVolume = value;
			_audioSources[(int)Define.Sound.Bgm].volume = MasterVolume * bgmVolume;
		}
	}
	...
	public float EffectVolume
	{
		...
		{
			effectVolume = value;
			_audioSources[(int)Define.Sound.Effect].volume = MasterVolume * effectVolume;
		}
	}
...
/*#if !UNITY_EDITOR && UNITY_IOS
	...
	private void SetVolume()
	{
		...
		_audioSources[(int)Define.Sound.Speech].volume = EffectVolume;
		_audioSources[(int)Define.Sound.Effect].volume = EffectVolume;
		_audioSources[(int)Define.Sound.Effect2].volume = EffectVolume;
		_audioSources[(int)Define.Sound.Effect3].volume = EffectVolume;
	}
	...
	public void PlayAudioClip(Define.Sound type, string clipName)
	{
		...
		PlayAudioClip(type, clips[clipName]);
	}
